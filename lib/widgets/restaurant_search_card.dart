...
class RestaurantSearchCard extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  final RestaurantSearchData restaurant;
  const RestaurantSearchCard({super.key, required this.restaurant});

  @override
  State<RestaurantSearchCard> createState() => _RestaurantSearchCardState();
}

class _RestaurantSearchCardState extends State<RestaurantSearchCard> {
  @override
